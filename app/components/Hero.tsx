        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_700px]">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 w-full sm:w-auto">
              ...
              <Link
                className="inline-flex h-11 items-center justify-center rounded-lg bg-[#590099] text-white px-6 text-sm font-medium shadow transition-colors hover:bg-[#900059] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white"
                href="/chat"
              >
                Join Chat
